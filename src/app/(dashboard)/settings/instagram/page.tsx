...
export default async function InstagramSettingsPage() {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle>پیکربندی اپلیکیشن</CardTitle></CardHeader>
        <CardContent className="space-y-3 text-sm">
          ...
          <Kv k="App Secret" v="•••••••••••••••• (هرگز نمایش داده نمی‌شود)" />
          <Alert variant="info">
            مقادیر Redirect URI و Webhook Callback URL باید <strong>دقیقاً</strong> در Meta App Dashboard ثبت شده باشند،
            وگرنه فرآیند اتصال با خطا مواجه می‌شود.
          </Alert>
        </CardContent>
      </Card>
